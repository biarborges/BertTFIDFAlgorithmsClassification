...
df = pd.read_csv("../corpus_embeddings.csv")
...
plt.savefig("matriz_confusao_embeddings.png")  # Salva como imagem
plt.close()  # Fecha a figura

print("✅ Matriz de Confusão salva como 'matriz_confusao_embeddings.png'.")
