...
# 1. Carregar dados
df = pd.read_csv("corpus_processadoBERT_classesNumericas.csv")
...
output_df.to_csv("resultado_classificacao.csv", index=False)

print("Classificação finalizada e arquivo salvo como 'resultado_classificacao.csv'")
