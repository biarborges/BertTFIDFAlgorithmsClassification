...
saida_csv = "../BertTFIDFAlgorithmsClassification/3.fake.br - Código multi classes ptbr/corpus_processadoTFIDF_classesNumericas.csv"

# Lê o CSV de entrada
df = pd.read_csv(entrada_csv)

# Inicializa o LabelEncoder e transforma a coluna 'categoria'
le = LabelEncoder()
