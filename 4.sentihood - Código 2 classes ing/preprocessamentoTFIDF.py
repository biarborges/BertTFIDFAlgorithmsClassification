...
# Caminhos
arquivo_csv = "../BertTFIDFAlgorithmsClassification/4.sentihood - Código 2 classes ing/sentihood2.csv"
saida_csv = "../BertTFIDFAlgorithmsClassification/4.sentihood - Código 2 classes ing/corpus_processadoTFIDF.csv"
